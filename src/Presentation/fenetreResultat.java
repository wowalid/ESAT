...
public class fenetreResultat extends JFrame{
	...
	public fenetreResultat (Donnees donnees) { 
		...
		this.donnees.addObserver(new controlLabel(0,this.donnees.ResultatParMachine,prix1,this.donnees,mach1));
		m1.add(mach1);
		m1.add(prix1);
		...
		this.donnees.addObserver(new controlLabel(1,this.donnees.ResultatParMachine,prix2,this.donnees,mach2));
		m2.add(mach2);
		m2.add(prix2);
		...
		this.donnees.addObserver(new controlLabel(2,this.donnees.ResultatParMachine,prix3,this.donnees,mach3));
		m3.add(mach3);
		m3.add(prix3);
		...
		this.donnees.addObserver(new controlLabel(3,this.donnees.ResultatParMachine,prix4,this.donnees,mach4));
		m4.add(mach4);
		m4.add(prix4);
		...
		this.donnees.addObserver(new controlLabel(4,this.donnees.ResultatParMachine,prix5,this.donnees,mach5));
		m5.add(mach5);
		m5.add(prix5);
